...
import {
  ArrowDownRight, ArrowRight, ChevronDown, Clock3, Instagram,
        ...
        <section id="carte" className="mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-32">
          ...
          <div className="mt-12 grid gap-10 md:grid-cols-2">
            {[
              ...
              <div key={title} className="rounded-[2rem] border border-[#d9cebf] bg-[#eee6db] p-7 md:p-9">
                <div className="flex items-center justify-between border-b border-[#d1c4b5] pb-5">
                  <h3 className="font-display text-3xl">{title}</h3><span className="text-[#b94f2e]">✦</span>
                </div>
                <div>
        ...
        <section id="galerie" className="px-5 pb-24 md:px-8 md:pb-32">
          <div className="mx-auto max-w-7xl">
            <div className="mb-10 flex items-end justify-between">
              ...
              <a href="https://instagram.com/" className="hidden items-center gap-2 text-sm font-semibold md:flex"><Instagram size={18}/> Instagram</a>
            </div>
